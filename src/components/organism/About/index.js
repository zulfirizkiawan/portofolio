...
export default function About() {
  ...
  return (
    <div
      id="about"
      className="w-full p-2 flex flex-col py-10 px-10 pt-20 sm:pt-0"
    >
        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-2 mt-5 gap-10">
          ...
          <div className="col-span-3  h-auto">
            ...
            <div
              ...
              data-aos-offset="200"
            >
              <div className="flex flex-col  py-10 shadow-lg shadow-gray-300 p-3 rounded-lg justify-center items-center ">
                <BiMedal size={30} />
